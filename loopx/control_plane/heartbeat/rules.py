...
SCHEDULER_HINT_APPLICATION_RULE = (
    ...
    "adopt_managed_bootstrap -> its prompt-only api_update_request once, no spend, "
    "then readback; else apply_needed -> RRULE via automation_update; unavailable -> "
...
SCHEDULER_HINT_COMPACT_RULE = (
    ...
    "prompt_adoption.host_action=adopt_managed_bootstrap: prompt-only "
    "api_update_request once, no spend; "
