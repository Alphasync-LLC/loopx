import {manageAutomationCadence, projectCadenceProgression} from "./quota/automation_cadence.ts";
...
export function createEffectRuntimeHandlers(
  ...
  return new Map<string, EffectRuntimeHandler>([
    ...
    ["quota.automation_cadence.progression", projectCadenceProgression],
